  ...
  return (
    <MainLayout>
      <div className="flex flex-col h-[calc(100vh-6rem)] max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-900/80 border border-slate-800 backdrop-blur-md mb-4 shrink-0 shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-100 flex items-center gap-2">
                <span>Python Documentation RAG Assistant</span>
                <span className="px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-[10px] font-medium hidden sm:inline-flex items-center gap-1">
              ...
              <p className="text-xs text-slate-400">
                {documents.length > 0
                  ? `Grounding answers in ${documents.length} uploaded PDF document(s)`
                  : 'No custom PDFs uploaded yet. Answers derived from general Python specs.'}
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-medium transition"
          >
